...
echo "<pre>Setup by KerduNet.Top [082210988552]</pre>" > /home/vps/public_html/index.html
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/kerdunet/centos/master/conf/squid-centos.conf"
